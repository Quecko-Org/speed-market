...
    { name: "Base", img: "/assets/base.png" },
    { name: "Ethereum", img: "/assets/eth.png" },
    { name: "Bitcoin", img: "/assets/btc.png" },
  ];
  return (
    <>
        ...
        <Modal.Body>
          <div className="depositcontent">
            ...
            <div className="mainqr">
              ...
              <img src="/modalassets/qr.png" alt="img" className="img-fluid qrimg" />
            </div>
